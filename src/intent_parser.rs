...
mod __parse__Blah {
    ...
    ) -> Result<(), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match try!(__state0(input, &mut __tokens, __lookahead)) {
            ...
            (None, __Nonterminal::____Blah((_, __nt, _))) => {
                Ok(__nt)
            }
            _ => unreachable!(),
        }
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            None => {
                ...
                let __nt = __Nonterminal::____Blah((
                    __start,
                    __nt,
                    __end,
                ));
...
pub use self::__parse__Blah::parse_Blah;
mod __intern_token {
    extern crate lalrpop_util as __lalrpop_util;
    use self::__lalrpop_util::ParseError as __ParseError;
